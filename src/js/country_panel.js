...
import {
  myChart, graphConfig, graphControlPanel, graphWrapper,
} from './graph';
=======
...
const excludeCountries = ['AIA', 'ABW', 'BMU', 'VGB', 'BES', 'JEY', 'CUW', null, 'FLK', 'FRO', 'GUF', 'PYF', 'GIB',
  ...
  for (let index = 0; index < countryNamesArray.length; index++) {
    ...
    option.addEventListener('click', async function getTotalCountryData() {
      ...
      if (currentCountry !== this.children[1].textContent) {
        ...
        console.log(selectedCountryRecoveredCummulative);
